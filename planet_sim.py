...
class Planet:
    ...
    SCALE = 250 / AU # 1AU = 100 pixels, lower value means smaller scale
    ...
    def update_position(self, planets):
        ...
        self.x_vel += total_fx / self.mass * self.TIMESTEP # This is just f=m/a and then shove it into self.x_vel
...
def main():
    ...
    mercury = Planet(0.387 * Planet.AU, 0, 6, DARK_GREY, 3.30 * 10**23)
